...
interface AddIndividualCyopFileProps {
  setPath: any
}

export const AddIndividualCyopFile: FC<AddIndividualCyopFileProps> = ({setPath}) => {
  ...
  return (
    <div className="co-left-panel">
      <AddTokenDescription title="individual_file_creation" />
...
export default AddIndividualCyopFile;
